                        ...
                        <div class="filter-input row">
                            <div class="col-md-10">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="box-filter-item">
                                            <?=$func->get_attribute_input(@$_GET['id_khoihanh'],'id_khoihanh','khoi-hanh','Chọn điểm khởi hành')?>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="box-filter-item">
                                            <?=$func->get_attribute_input(@$_GET['id_noiden'],'id_noiden','noi-den','Chọn điểm đến')?>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="box-filter-item">
                                            <?=$func->get_attribute_input(@$_GET['id_songaydi'],'id_songaydi','so-ngay-di','Chọn số ngày đi')?>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="box-filter-item">
