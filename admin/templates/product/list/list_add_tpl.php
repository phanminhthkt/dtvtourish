            ...
            <div class="<?=$colRight?>">
                ...
                <?php if(isset($config['product'][$type]['icon_list']) && $config['product'][$type]['icon_list'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        ...
                        <div class="card-body">
                            <?php
                                $photoDetail2 = UPLOAD_PRODUCT.@$item['icon'];
                                $dimension2 = "Width: ".$config['product'][$type]['width_icon_list']." px - Height: ".$config['product'][$type]['height_icon_list']." px (".$config['product'][$type]['img_type_list'].")";
