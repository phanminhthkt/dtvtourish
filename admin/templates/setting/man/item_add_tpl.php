			...
			<div class="card-body">
				...
				<div class="row">
					...
					<?php if(isset($config['setting']['hotline']) && $config['setting']['hotline'] == true) { ?>
						...
						<div class="form-group col-md-4 col-sm-6">
							<label for="hotline">Hotline 2:</label>
						...
						<div class="form-group col-md-4 col-sm-6">
							...
							<input type="text" class="form-control" name="data[options][skype]" id="skype" placeholder="Skype" value="<?=$options['skype']?>">
						</div>
					<?php } ?>
					...
					<?php } ?>
					<?php if(isset($config['setting']['time']) && $config['setting']['time'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="timework">Giờ làm việc:</label>
							<input type="text" class="form-control" name="data[options][timework]" id="timework" placeholder="timework" value="<?=$options['timework']?>">
						</div>
					<?php } ?>
