    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item"><a href="<?=$linkMan?>" title="Quản lý đơn hàng">Quản lý tour</a></li>
                <li class="breadcrumb-item active">Thông tin tour <span class="text-primary">#<?=$item['matour']?></span></li>
            </ol>
        </div>
    </div>
</section>
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body row">
                <div class="form-group col-md-4 col-sm-6">
					<label>Mã tour:</label>
					<p class="text-primary"><?=@$item['matour']?></p>
				</div>
				<div class="form-group col-md-4 col-sm-6">
					<label>Hình thức thanh toán:</label>
					<p class="text-info">
						<?php 
                            if($item['status_vnpay']!=''){
                                echo '<span class="d-block">Thanh toán online</span>';
                            }else{
                                echo $func->get_payments($item['httt']);
                            }
                        ?>
						<?=$func->get_payments(@$item['httt'])?>
					</p>
				</div>
				<div class="form-group col-md-4 col-sm-6">
					<label>Họ tên:</label>
	            ...
	            <table class="table table-hover">
	                <thead>
	                    <tr>
	                        ...
	                        <th class="align-middle" style="width:30%">Tên tour</th>
	                        <th class="align-middle text-center" style="width:30%">Giá x Số lượng</th>
	                            ...
	                            <tr>
	                                ...
	                                <td class="align-middle">
	                                	<div class="price-cart-detail">
	                                		<p>Giá người lớn : <span class="price-new-cart-detail"><?=$func->format_money($v['gianguoilon'])?></span><span style="color:blue"> x <?=$v['songuoilon']?></span></p>
	                                		<p>Giá trẻ em : <span class="price-new-cart-detail"><?=$func->format_money($v['giatreem'])?></span><span style="color:blue"> x <?=$v['sotreem']?></span></p>
	                                		<p>Giá em bé : <span class="price-new-cart-detail"><?=$func->format_money($v['giaembe'])?></span><span style="color:blue"> x <?=$v['soembe']?></span></p>
	                                		<p>Phụ thu phòng dọn : <span class="price-new-cart-detail"><?=$func->format_money($v['phuthuphongdon'])?></span></p>
	                                		<p>Chi phí khác : <span class="price-new-cart-detail"><?=$func->format_money($v['chiphikhac'])?></span></p>
										</div>
	                                </td>
	                                <td class="align-middle text-right">
	                                	<div class="price-cart-detail">
											<span class="price-new-cart-detail"><?=$func->format_money($item['tonggia'])?></span>
										</div>
	                                </td>
	                            </tr>
	                        <?php } ?>
