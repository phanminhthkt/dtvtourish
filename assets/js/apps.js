...
if($(".tit-module").exists()){
    $(".tit-module").click(function(){
        if($(this).parent().find('.content-module').is(":hidden")){
            $(this).parent().find('.content-module').slideDown(300);
            $(this).addClass('active');
        }else{
            $(this).parent().find('.content-module').slideUp(300);
...
if($(".paging-product-category").exists())
{
    $(".paging-product-category").each(function(){
        ...
        loadPagingAjax("ajax/ajax_product.php?perpage=12&idCat="+cat,'.paging-product-category-'+cat);
    })
}
if($(".item_tab_index_cat").exists()){
    $('.item_tab_index_cat').click(function(){
        $(this).parents(".cover-product").find('.item_tab_index_cat').removeClass('active');
        var id_tab=$(this).attr('href');
        $(this).addClass('active');
        $(this).parents(".cover-product").find('.content_tab_index_cat').css({'display':'none'});
        $(this).parents(".cover-product").find(id_tab).fadeIn();
        return false;
    });
}
...
NN_FRAMEWORK.OwlPage = function(){
    if($(".owl-slideshow").exists())
    {
        $('.owl-slideshow').owlCarousel({
            ...
            animateOut: 'animated fadeOutRight',
            margin: 0,
            smartSpeed: 500,
            autoplaySpeed: 3500,
            nav: false,
