...
define("sanphamcungloai","Tour cùng loại");
define("conhang","Còn hàng");
define("thanhtoan","Thanh toán");
define("thanhtoanthuong","Thanh toán thường");
define("thanhtoanonline","Thanh toán online");
...
define("dichvuvisa","Dịch vụ visa");
define("vemaybay","Vé máy bay");
define("khachsan","Khách sạn");
define("xedulich","Xe du lịch");
define("dichvukhachdoan","Dịch vụ khách đoàn");
define("dichvukhac","Dịch vụ khác");
define("huongdanvien","Hướng dẫn viên");
define("timkiemtour","Tìm kiếm tour");
define("tour","Tour");
define("ngaykhoihanh","Ngày khởi hành");
define("noikhoihanh","Nơi khởi hành");
define("ketnoivoichungtoi","Kết nối với chúng tôi");
define("dat","Đặt");
define("quydinh","Quy định");
define("lichtrinh","Lịch trình");
define("lidochon","Lí do chọn");
define("tourkhuyenmai","Tour khuyến mãi");
define("noiden","Nơi đến");
define("phuongtien","Phương tiện");
define("socho","Số chỗ");
define("dattour","Đặt tour online");
define("chonve","Chọn vé");
define("datve","Đặt vé");
define("thongtintour","Thông tin tour");
define("giatour","Giá tour");
define("songuoilon","Người lớn (Từ 11 tuổi trở lên)");
define("sotreem","Trẻ em (Từ 6 tuổi đến dưới 10 tuổi - Ngủ chung người lớn)");
define("soembe","Em bé (Dưới 6 tuổi - Ngủ chung người lớn)");

define("so","Số");
define("nguoilon","Người lớn");
define("treem","Trẻ em");
define("embe","Em bé");
define("phuthu","Phụ thu phòng đơn");
define("khac","Khác");
define("chiphikhac","Chi phí khác");
define("songaydi","Số ngày đi");
define("mienphi","Miễn phí");
define("thongtinnguoidat","Thông tin người đặt");
define("soluongnguoi","Số lượng người");
define("vuilongnhapsonguoilon","Số lượng người");
define("vuilongnhapsotreem","Số lượng người");
define("vuilongnhapsoembe","Số lượng người");
define("ghichu","Ghi chú");
define("chondiemkhoihanh","Chọn điểm khởi hành");
define("chonsongaydi","Chọn số ngày đi");
define("chondiemden","Chọn điểm đến");
?>